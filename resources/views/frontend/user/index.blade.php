                        ...
                        <div class="row">
                            ...
                            <div class="col-lg-7 col-md-7 col-sm-12">
                                <div class="row">
                                    ...
                                    <div class="col-12">
                                        <div class="title"><h5><a class="nav-link text-success" href="{{route('post-item',$p->id)}}">{{Str::limit($p->title,80)}}</a></h5></div>
                                        <div class="body"><p>{{Str::limit($p->body,240)}}</p></div>
                                    </div>
                                    @endforeach
                                </div>
                                <div class="d-felx justify-content-center">

                                    {{ $postlist->links('pagination::bootstrap-5') }}
